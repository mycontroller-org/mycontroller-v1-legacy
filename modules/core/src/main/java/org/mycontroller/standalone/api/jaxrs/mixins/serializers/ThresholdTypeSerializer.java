 ...
 * @since 0.0.2
 */
public class ThresholdTypeSerializer extends JsonSerializer<DATA_TYPE> {

    @Override
    public void serialize(DATA_TYPE type, JsonGenerator jgen, SerializerProvider provider)

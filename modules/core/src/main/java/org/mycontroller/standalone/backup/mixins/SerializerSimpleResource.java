...
public class SerializerSimpleResource extends JsonSerializer<Resource> {

    @Override
    public void serialize(Resource item, JsonGenerator jgen, SerializerProvider provider) throws IOException,

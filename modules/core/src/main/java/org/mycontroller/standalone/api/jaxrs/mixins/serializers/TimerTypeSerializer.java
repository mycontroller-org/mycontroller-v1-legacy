 ...
 * @since 0.0.2
 */
public class TimerTypeSerializer extends JsonSerializer<TIMER_TYPE> {

    @Override
    public void serialize(TIMER_TYPE type, JsonGenerator jgen, SerializerProvider provider)

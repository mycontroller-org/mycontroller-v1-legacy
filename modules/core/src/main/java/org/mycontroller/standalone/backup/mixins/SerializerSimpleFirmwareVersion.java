...
public class SerializerSimpleFirmwareVersion extends JsonSerializer<FirmwareVersion> {

    @Override
    public void serialize(FirmwareVersion item, JsonGenerator jgen, SerializerProvider provider) throws IOException,

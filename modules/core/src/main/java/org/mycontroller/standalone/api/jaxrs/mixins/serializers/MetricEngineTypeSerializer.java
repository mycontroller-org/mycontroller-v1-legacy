 ...
 * @since 0.0.3
 */
public class MetricEngineTypeSerializer extends JsonSerializer<METRIC_ENGINE> {

    @Override
    public void serialize(METRIC_ENGINE type, JsonGenerator jgen, SerializerProvider provider)

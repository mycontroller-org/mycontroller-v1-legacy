...
public class SerializerSimpleFirmwareType extends JsonSerializer<FirmwareType> {

    @Override
    public void serialize(FirmwareType item, JsonGenerator jgen, SerializerProvider provider) throws IOException,

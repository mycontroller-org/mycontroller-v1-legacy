...
public class SerializerSimpleRole extends JsonSerializer<Role> {

    @Override
    public void serialize(Role item, JsonGenerator jgen, SerializerProvider provider) throws IOException,

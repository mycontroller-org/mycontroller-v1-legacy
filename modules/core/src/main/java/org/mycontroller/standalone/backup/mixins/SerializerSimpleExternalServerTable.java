...
public class SerializerSimpleExternalServerTable extends JsonSerializer<ExternalServerTable> {

    @Override
    public void serialize(ExternalServerTable item, JsonGenerator jgen, SerializerProvider provider)
            throws IOException,

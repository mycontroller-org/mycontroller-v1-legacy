...
public class SerializerSimpleRoom extends JsonSerializer<Room> {

    @Override
    public void serialize(Room item, JsonGenerator jgen, SerializerProvider provider) throws IOException,

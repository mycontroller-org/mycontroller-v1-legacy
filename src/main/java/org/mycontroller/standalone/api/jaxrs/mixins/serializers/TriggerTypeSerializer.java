 ...
 * @since 0.0.2
 */
public class TriggerTypeSerializer extends JsonSerializer<TRIGGER_TYPE> {

    @Override
    public void serialize(TRIGGER_TYPE type, JsonGenerator jgen, SerializerProvider provider)

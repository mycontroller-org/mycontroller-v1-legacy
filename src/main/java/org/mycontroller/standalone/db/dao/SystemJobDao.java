...
public interface SystemJobDao {
    ...
    void create(SystemJob systemJob);

    void createOrUpdate(SystemJob systemJob);

    void delete(SystemJob systemJob);

    void update(SystemJob systemJob);

    List<SystemJob> getAll();

    List<SystemJob> getAllEnabled();

    SystemJob get(SystemJob systemJob);

    SystemJob get(Integer id);
}

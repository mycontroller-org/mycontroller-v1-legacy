...
==== WIKI: http://www.mycontroller.org
...
MyController.org server is very lightweight, It required very less resource, believe me ;)
  ...
  * Java        : 1.8 or later
  ...
  NOTE: Test done up to 5 nodes and 20 sensors with the above configuration.
...
Features available in https://github.com/mycontroller-org/mycontroller/releases/tag/0.0.2-alpha3[0.0.2-alpha3] version,
...
* https://github.com/mycontroller-org/mycontroller/releases/download/0.0.2-alpha3/mycontroller-standalone-0.0.2-alpha3-bundle.zip[mycontroller-standalone-0.0.2-alpha3-bundle.zip]
* https://github.com/mycontroller-org/mycontroller/releases/download/0.0.2-alpha3/mycontroller-standalone-0.0.2-alpha3-bundle.tar.gz[mycontroller-standalone-0.0.2-alpha3-bundle.tar.gz]

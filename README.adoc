...
Features available in https://github.com/mycontroller-org/mycontroller/releases/tag/0.0.2-alpha4[0.0.2-alpha4] version,
...
* https://github.com/mycontroller-org/mycontroller/releases/download/0.0.2-alpha4/mycontroller-standalone-0.0.2-alpha4-bundle.zip[mycontroller-standalone-0.0.2-alpha4-bundle.zip]
* https://github.com/mycontroller-org/mycontroller/releases/download/0.0.2-alpha4/mycontroller-standalone-0.0.2-alpha4-bundle.tar.gz[mycontroller-standalone-0.0.2-alpha4-bundle.tar.gz]

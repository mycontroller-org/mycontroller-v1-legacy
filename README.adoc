...
image:https://www.transifex.com/projects/p/gui-angularjs/resource/mc_locale_gui/chart/image_png[link="https://www.transifex.com/mycontrollerorg/gui-angularjs/"]
